...
public class CustomListeners extends Page implements ITestListener,ISuiteListener
{
	...
	public void onTestFailure(ITestResult result)
	{
			...
			test.log(LogStatus.FAIL, test.addScreenCapture(Utilities.screenshotName));		//extent
	...
	public void onFinish(ITestContext context)
	{
		...
		try {
			messageBody = "http://"+ InetAddress.getLocalHost().getHostAddress()+":8080/job/LivePageObjectModelProject/HTML_20Report/";
